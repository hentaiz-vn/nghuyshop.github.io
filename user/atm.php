 ...
 <form method="POST" action="/atm" accept-charset="UTF-8" enctype="multipart/form-data"><input name="_token" type="hidden" value="7mjSAWzGmgGvTOk3PfRY089LeW1tHuW4PMUHKBmF">
...
<div class="modal-body">
	...
	<tbody>
		<tr>
			<th colspan="2">Chủ tài khoản: NGUYEN VIET DUONG&nbsp; &nbsp;&nbsp;</th>
		...
		<tr>
			...
			<!--<th>Bình Chánh</th>-->
                ...
                <div class="tut-charge" style="background-color: #ffffff;padding-top: 15px">
                    <p>Nội dung chuyển khoản: <strong>Nap </strong>&nbsp;+ t&ecirc;n t&agrave;i khoản hoặc ID t&agrave;i khoản</p>

<p>Chuyển xong li&ecirc;n hệ facebook :&nbsp;<strong><a href="https://www.facebook.com/duong41DH3" target="_blank">Admin Dương Dũng</a></strong>&nbsp;hoặc Hotline&nbsp;<strong>0984.024.097</strong>&nbsp;để được xử l&yacute;.</p>
                </div>
	...
	<tbody>
		<tr>
			<!--<td><strong>DCN (Doicardnhanh.com)</strong></td>-->
			<!--<td><strong>doicardnhanh</strong></td>-->
		</tr>
		<tr>
			<td><strong>Momo/Zalo pay</strong></td>
			<td><strong>0984.024.097</strong></td>
...
<p>Chuyển xong li&ecirc;n hệ facebook :&nbsp;<strong><a href="https://www.facebook.com/duong41DH3" target="_blank">Admin Dương Dũng</a></strong>&nbsp;hoặc Hotline&nbsp;<strong>0984.024.097</strong>&nbsp;để được xử l&yacute;.</p>
		...
		<tr>
			<!--<td><strong>Viettel Pay</strong></td>-->
			<!--<td><strong></strong></td>-->
		</tr>
	</tbody>
</table>
